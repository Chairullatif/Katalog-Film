...
import com.khoirullatif.katalogfilm.data.CatalogDataSource;
import com.khoirullatif.katalogfilm.data.CatalogRepository;
import com.khoirullatif.katalogfilm.data.NetworkBoundResource;
...
public class FakeCatalogRepository implements CatalogDataSource {
    ...
    public FakeCatalogRepository(@NonNull RemoteDataSource remoteDataSource, @NonNull LocalDataSource localDataSource, AppExecutors appExecutors) {
